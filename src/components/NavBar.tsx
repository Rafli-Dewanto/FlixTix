            ...
            <ul className="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  to={`/`}
                  className={`block ${
                    page === '' ? 'text-dodger-blue-500' : 'black'
              ...
              <li>
                <Link
                  to={`/profile`}
                  className={`block ${
                    page === 'profile' ? 'text-dodger-blue-500' : 'black'
                  } py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent`}
                >
                  My Account
                </Link>
              </li>
